...
# python video_stab.py --video_name 1.mp4 --dataset UAV --save --estModel homography --smooth_win_len 250 --smooth_order 3 --max_frame 1500 --video_offset 900 --feat_ext GFTT
# python video_stab.py --video_name 1.mp4 --dataset UAV1 --save --estModel affine --smooth_win_len 250 --smooth_order 3 --max_frame 900 --video_offset 0 --debug --feat_ext GFTT
# python video_stab.py --video_name 1.mp4 --dataset UAV1 --save --estModel homography --smooth_win_len 250 --smooth_order 3 --max_frame 900 --video_offset 0 --debug --feat_ext GFTT